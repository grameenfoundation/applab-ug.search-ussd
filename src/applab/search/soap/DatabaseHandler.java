...
public class DatabaseHandler {
    ...
    static PreparedStatement buildSelectQuery(StringBuilder commandText) throws ClassNotFoundException, SQLException {
        PreparedStatement selectStatement = null;
        try {
            connection = DatabaseHelpers.createReaderConnection(WebAppId.AppLabWebService);
            System.out.println("Database connection established");

            // prepare select statement
            selectStatement = connection.prepareStatement(commandText.toString());
        }
        catch (Exception e) {
    ...
    private static PreparedStatement buildNonSelectQuery(StringBuilder commandText) throws ClassNotFoundException, SQLException {
        PreparedStatement insertStatement = null;
        try {
            connection = DatabaseHelpers.createConnection(WebAppId.AppLabWebService);
            System.out.println("Database connection established");

            // prepare non-select statement
            insertStatement = connection.prepareStatement(commandText.toString());
        }
        catch (Exception e) {
            System.err.println("Cannot connect to database server");
            logger.warning(e.getMessage());
    ...
    public static UssdMenu getDisplayedMenu(UssdRequest request) throws Exception {
    ...
    public static UssdMenu getRequestedMenu(String breadCrumb, Integer categoryId) throws Exception {
    ...
    public static String getContent(String breadCrumb, Integer categoryId) throws Exception {
        String content = "";
    ...
    public static void logRequest(UssdRequest request, UssdMenu currentMenu, int complete) throws Exception {
        ...
        insertStatement.setString(2, currentMenu.getMenuString("##", false, currentMenu.getItemCount() + 1, 1));
        insertStatement.setInt(3, currentMenu.getPage());
        insertStatement.setInt(4, ((null == currentMenu.getCategoryId()) ? 0 : currentMenu.getCategoryId()));
        insertStatement.setString(5, ((null == currentMenu.getBreadCrumb()) ? "" : currentMenu.getBreadCrumb()));
    ...
    public static String getCategoryNameFromId(Integer categoryId) throws Exception {
